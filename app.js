...
`npm install`: Con esto instalaremos las dependecia de express    ok

📂 Estructura del Código

📄 app.js: Contiene el código principal de la aplicación con la configuración de Express, middleware y rutas.  ok
📂 middlewares: Carpeta que contiene los middlewares para obtener la hora actual y la validación.  ok
...
📂 routes: Carpeta que contiene los módulos de rutas.   ok
...
- Un texto de bienvenida y la hora actual   ok
- Un botón que enlace `/endroute`   ok
...
app.use('/',horaMiddleware,validarHora,router)
